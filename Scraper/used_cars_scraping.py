...
from cities_scraping import cities
...
def runScraper():
    ...
    curs.execute("CREATE TABLE IF NOT EXISTS vehicles(id BIGINT PRIMARY KEY, url TEXT, region TEXT,"
                 " region_url TEXT, price BIGINT, years BIGINT, manufacturer TEXT, model TEXT,"
                 " conditions TEXT, cylinders TEXT, fuel TEXT, odometer BIGINT, title_status TEXT, transmission TEXT, VIN TEXT,"
                 "drive TEXT, sizes TEXT, types TEXT, paint_color TEXT, image_url TEXT,county TEXT, state TEXT,"
    ...
    for city in citiesList:
        ...
        while not empty:
            ...
            for item in vehiclesList:
                ...
                curs.execute('''INSERT INTO vehicles(id, url, region, region_url, price, years, manufacturer, model, conditions,
                                    cylinders, fuel,odometer, title_status, transmission, VIN, drive, sizes, types, 
                                    paint_color, image_url, latitude, longitude, state)
                VALUES(%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s)''',
                             (idpk, url, city[2], city[1], price, year, manufacturer, model, condition, cylinders,
                              fuel, odometer, title_status, transmission, VIN, drive,
                              size, vehicle_type, paint_color, image_url, lat, long, city[3]))
    ...
    print("Table vehicles successfully updated, {} entries exist".format(curs.fetchall()[0][0]))
    conn.close()
